const Contact = () => {
  return (
    <div className="h-screen flex justify-center items-center bg-cover bg-center bg-fixed p-4 overflow-hidden" style={{ backgroundImage: "url(https://previews.123rf.com/images/prescott09/prescott091702/prescott09170200456/72299138-background-shot-of-aqua-sea-water-surface.jpg)" }}>
      <form className="bg-transparent p-6 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg border border-white backdrop-blur-lg">
